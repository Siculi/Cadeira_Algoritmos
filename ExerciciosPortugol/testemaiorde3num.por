programa
{
	...
	funcao inicio()
	{
		real n1, n2, n3
			...
			se((n3==n2) ou (n3==n1) ou (n2==n1)) {escreva("\nSeu burro, você digitou um ou mais números iguais!!!\n")}

			senao
			{
			se(n3>n2 e n2>n1) {escreva(n3," é o maior número")}
			se(n3>n1 e n1>n2) {escreva(n3," é o maior número")}
			se(n2>n3 e n3>n1) {escreva(n2," é o maior número")}
			se(n2>n1 e n1>n3) {escreva(n2," é o maior número")}
			se(n1>n2 e n2>n3) {escreva(n1," é o maior número")}
			se(n1>n3 e n3>n2) {escreva(n1," é o maior número")}
